...
# This module defines a list of warnings called RANDOM_CODING_WARNING_FLAGS. They can be enabled by using:
# target_compile_options(${TARGET_NAME} PRIVATE ${RANDOM_CODING_WARNING_FLAGS})

include_guard(GLOBAL)

option(RANDOM_CODING_WARNINGS_AS_ERRORS "Treat RANDOM_CODING_WARNING_FLAGS as errors." ON)

if (CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
	option(RANDOM_CODING_CLANG_ALL_WARNINGS
		"Include (almost) all Clang warnings. This may trigger unexpected positives when using newer Clang versions." ON)
endif ()

message(STATUS "Defining RANDOM_CODING_WARNING_FLAGS")

set(RANDOM_CODING_WARNING_FLAGS)

if (RANDOM_CODING_CLANG_ALL_WARNINGS AND CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
	list(APPEND RANDOM_CODING_WARNING_FLAGS
...
if (RANDOM_CODING_WARNINGS_AS_ERRORS)
	if (CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
		list(APPEND RANDOM_CODING_WARNING_FLAGS -Werror)
	elseif (CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
		list(APPEND RANDOM_CODING_WARNING_FLAGS /WX)
	endif ()
endif ()
